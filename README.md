...
**软件上**, 没有ESP-IDF开发环境的可以通过乐鑫官方的烧录工具, 选择项目中编译好的 Bin 文件通过串口烧录进去, 烧录时要全程按住中间的功能键, 由于固件较大, 烧录时间较长, 可以直接拿个小夹子夹住按键进行烧录.
**总体复刻难度中等, 材料成本90RMB左右.**
![装配图](Docs/Images/Assembly.jpg)
# 二次开发
>本项目开发环境为Windows加Docker
```
ComLink/
├── main/ 
│   └── main.cpp
